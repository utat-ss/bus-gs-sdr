...
class audio_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_bladerf_source_0.set_frequency(0, (freq_rx + freq_shift))
        self.soapy_bladerf_source_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0.set_gain(0, min(max(rx_gain_b, -1.0), 60.0))
        ...
        self.soapy_bladerf_sink_0.set_frequency(0, freq_tx)
        self.soapy_bladerf_sink_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_sink_0.set_gain(0, min(max(tx_gain_b, 17.0), 73.0))
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('wahahaha.mp3', True)
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.blocks_freqshift_cc_0, 0))
    ...
    def set_tx_gain_b(self, tx_gain_b):
        ...
        self.soapy_bladerf_sink_0.set_gain(0, min(max(self.tx_gain_b, 17.0), 73.0))
    ...
    def set_rx_gain_b(self, rx_gain_b):
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(self.rx_gain_b, -1.0), 60.0))
    ...
    def set_freq_tx(self, freq_tx):
        ...
        self.soapy_bladerf_sink_0.set_frequency(0, self.freq_tx)
    ...
    def set_freq_shift(self, freq_shift):
        ...
        self.blocks_freqshift_cc_0.set_phase_inc(2.0*math.pi*int(self.freq_shift)/self.samp_rate)
        self.soapy_bladerf_source_0.set_frequency(0, (self.freq_rx + self.freq_shift))
