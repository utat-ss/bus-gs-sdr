...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_range = qtgui.Range(-samp_rate/2, samp_rate/2, samp_rate/20, 0, 200)
        ...
        self._amp_range = qtgui.Range(0, 89, 0.5, 1, 200)
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(40, -1.0), 60.0))
        ...
        self.blocks_freqshift_cc_0 = blocks.rotator_cc(2.0*math.pi*30e3/samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_freqshift_cc_0.set_phase_inc(2.0*math.pi*30e3/self.samp_rate)
