...
class bladerf_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BladeRF Debug", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BladeRF Debug")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "bladerf_test")
        ...
        self.qpsk_cons = qpsk_cons = digital.constellation_rect([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        4, 2, 2, 1, 1).base()
        self.freq = freq = 2e9
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_const_sink_x_0, 1))
