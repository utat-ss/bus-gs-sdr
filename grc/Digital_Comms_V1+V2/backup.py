...
class backup(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-0.001, 1)
        ...
        self.epy_block_1 = epy_block_1.blk(seed=0)
        self.epy_block_0 = epy_block_0.blk(buffer_size=20000, max_offset=50000, realign_interval=50000, periodic_realign=False)
        ...
        self._Tx_gain_range = qtgui.Range(0, 100, 1, 80, 200)
        ...
        self._Rx_gain_range = qtgui.Range(0, 100, 1, 80, 200)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.epy_block_0, 1))
        ...
        self.connect((self.epy_block_1, 0), (self.blocks_unpack_k_bits_bb_1, 0))
