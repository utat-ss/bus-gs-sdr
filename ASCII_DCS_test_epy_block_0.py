...
class blk(gr.sync_block):
    ...
    def __init__(self, message="HELLO"):
        ...
        # Clear files on init
        open("/Users/tomhaene/Documents/UofT/UTAT/tx_ascii.txt", "w").close()
        open("/Users/tomhaene/Documents/UofT/UTAT/tx_binary.txt", "w").close()
    ...
    def work(self, input_items, output_items):
        ...
        if text_ascii:
            with open("/Users/tomhaene/Documents/UofT/UTAT/tx_ascii.txt", "a") as f:
                f.write(text_ascii)
        
        if text_binary:
            with open("/Users/tomhaene/Documents/UofT/UTAT/tx_binary.txt", "a") as f:
                f.write(text_binary)
