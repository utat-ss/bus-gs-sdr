...
class blk(gr.sync_block):
    """Convert unpacked bits to ASCII text, save binary and ASCII versions"""
    ...
    def work(self, input_items, output_items):
        """Pack bits into bytes and convert to ASCII"""
        bits = input_items[0]
        ...
        # Write both files
        if text_ascii:
            with open("/home/tom/Documents/UofT/UTAT/SDR/Digital_Communication_System/data/rx_ascii.txt", "a") as f:
                f.write(text_ascii)
        
        if text_binary:
            with open("/home/tom/Documents/UofT/UTAT/SDR/Digital_Communication_System/data/rx_binary.txt", "a") as f:
                f.write(text_binary)
